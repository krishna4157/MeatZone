...
import VendorMainPage from './VendorMainPage';
import VendorDrawer from './VendorDrawer';
import { createStackNavigator } from 'react-navigation-stack';

const Tab = createStackNavigator();

function InitialVendorPage({ route, navigation}) {
  ...
  return (
    ...
    }} name="VendorMainPage" component={VendorMainPage} />
      <Tab.Screen 
    ...
    }} name="VendorSettings" component={ShopScreen} />
    <Tab.Screen 
    initialParams={{...route.params}}
    options={{
      tabBarShowLabel: false,
    ...
    }} name="VendorCart" component={CartPage} />
    <Tab.Screen
    initialParams={{...route.params}}
    ...
    }} name="VendorAppDrawer" component={VendorDrawer} />
    
    </Tab.Navigator>
  );
}

export default InitialVendorPage;