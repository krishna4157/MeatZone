...
export default function VendorProductStack() {
    return (
            <Stack.Navigator screenOptions={{
                headerShown: false,
            }} >    
            <Stack.Screen  options={{headerShown:true,title:'My Product',headerTitleAlign:'center'}} name="VendorProductPage" component={VendorProductPage} />
            <Stack.Screen  options={{headerShown:true,title:'Create Product',headerTitleAlign:'center'}} name="VendorProductCreatePage" component={VendorProductCreatePage} />
            </Stack.Navigator>
    );
}